...
class priority_queue {
    ...
    70 martin
    */
		pq.offer(new pair<>(100, "john")); // inserting a pair in O(log n)
		pq.offer(new pair<>(10, "billy"));
		pq.offer(new pair<>(20, "andy"));
		pq.offer(new pair<>(100, "steven"));
		pq.offer(new pair<>(70, "felix"));
		pq.offer(new pair<>(2000, "grace"));
		pq.offer(new pair<>(70, "martin"));
